...
def main(args):
    ...
    for train_index, val_index in kf.split(dataset):
        ...
        model = ResNetWithText(num_classes, text_feature_size)
        ...
        # criterion = CombinedLoss(alpha=1, beta=1.0, gamma=2.0, weight=weights, reduction='mean')
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--weights', type=str, default='../pre_weight/inceptionnext_tiny.pth',
